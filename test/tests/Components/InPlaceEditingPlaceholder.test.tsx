...
describe('InPlaceEditingPlaceholder', () => {
  test('renders placeholder when isInPlaceEditingActive is true', () => {
    ...
    const { getByText } = render(<InPlaceEditingPlaceholder>Your Placeholder Text Here</InPlaceEditingPlaceholder>);
  ...
  test('does not render placeholder when isInPlaceEditingActive is false', () => {
    ...
    const { queryByText } = render(<InPlaceEditingPlaceholder>Your Placeholder Text Here</InPlaceEditingPlaceholder>);
  ...
  test('applies "text-center" class when center prop is true', () => {
    ...
    const { container } = render(
      <InPlaceEditingPlaceholder center>Your Placeholder Text Here</InPlaceEditingPlaceholder>
    );
  ...
  test('does not apply "text-center" class when center prop is false', () => {
    ...
    const { container } = render(
      <InPlaceEditingPlaceholder>Your Placeholder Text Here</InPlaceEditingPlaceholder>
    );
  ...
  it('renders correctly', () => {
    const tree = renderer
      .create(<InPlaceEditingPlaceholder>Your Placeholder Text Here</InPlaceEditingPlaceholder>)
      .toJSON();
