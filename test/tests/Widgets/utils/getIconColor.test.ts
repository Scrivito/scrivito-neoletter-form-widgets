...
describe("getIconColor", () => {
  it('should return custom color when colorType is "custom"', () => {
    const customColorWidget = new DummyWidget({
      colorType: "custom",
      customColor: "#ff0000"
  ...
  it('should return secondary color when colorType is "secondary"', () => {
    const secondaryColorWidget = new DummyWidget({
      colorType: "secondary"
    }) as unknown as Widget;
  ...
  it('should return primary color when colorType is "primary"', () => {
    const primaryColorWidget = new DummyWidget({
      colorType: "primary"
    }) as unknown as Widget;
  ...
  it('should return "gold" as default color for other types', () => {
    const defaultColorWidget = new DummyWidget({
      colorType: "unknown"
    }) as unknown as Widget;
