...
describe("FormConditionWidget", () => {
    ...
    it('should  show condition-info & content if isInPlaceEditingActive is true', () => {
        ...
        const dummyContent = [new FormDateWidget({ customFieldName: "custom_date", title: "date", dateType: "date" })]
        pageRenderer.render({
    ...
    it('renders correctly', () => {
        const dummyContent = [new FormDateWidget({ customFieldName: "custom_date", title: "date", dateType: "date" })]
        const tree = pageRenderer.getAsJSON({ body: [new FormConditionWidget({ ...widgetProps, content: dummyContent })] })
