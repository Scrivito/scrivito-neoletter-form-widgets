...
const widget = new DummyWidget({
    headerType: 'dropdown', "title": "Select some",
    "helptext": "",
    "required": true,
    "customFieldName": "custom_header",
    "conditions": [new DummyWidget({ "title": "Apples" }), new DummyWidget({ "title": "Bananas" })]
...
describe('ConditionalHeader', () => {
    ...
    it('renders header-info when isInPlaceEditingActive is true', () => {
        ...
        const { queryByText } = render(
            <ConditionalHeader widget={widget} onChangeSelected={onChangeSelectedMock} />
        );
