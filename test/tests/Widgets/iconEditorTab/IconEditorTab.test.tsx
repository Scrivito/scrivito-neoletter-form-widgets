...
describe('IconEditorTab', () => {
    ...
    it('renders preview of the current icon', () => {
        ...
        const iconPreviewContainer = container.querySelector('.icon-editor-preview');
    ...
    it('searches for icons when a search value is entered', () => {
        const { getByLabelText, getByText } = render(<IconEditorTab widget={widget} />);

        fireEvent.change(getByLabelText('Search icons'), { target: { value: 'moon' } });
